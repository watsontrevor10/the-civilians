  ...
  <b-container fluid>
    ...
    <b-row class="extra-padding">
      <b-col cols="6">
        ...
        <div class="spaced-icons">
          <b-link
            href="https://twitter.com/civiliansrock"
            class="extra-padding"
          >
            <svg
          ...
          <b-link
            href="https://www.instagram.com/theciviliansband/"
            class="extra-padding"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <b-link
            href="https://www.facebook.com/theciviliansbandutah"
            class="extra-padding"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
